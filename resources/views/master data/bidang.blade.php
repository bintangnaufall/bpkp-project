    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="labelModal" style="color: black">Tambah Data Bidang</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form method="POST" id="bidangForm" action="javascript:void(0)">
            <input type="hidden" name="id" id="id">
            <input type="hidden" name="action" id="action">
            <label for="name" class="col-form-label" style="color: black">Nama Bidang</label>
            <input type="text" class="form-control" id="name" name="name" placeholder="Isi nama bidang" required>
...
//---------------------------------------------------- Tambah
            ...
            $('#newBidang').click(function () {
              $('#Modal').modal('show');
              $('#labelModal').html("Tambah Data Bidang");
...
//---------------------------------------------------- Submit
            ...
            $('#saveButton').click(function (e) {
                ...
                var form = document.getElementById('bidangForm');
                ...
                setTimeout(function() {
                    $.ajax({
                        type: "POST",
                        url: "{{ route('master_data.bidang.create_update') }}",
...
//---------------------------------------------------- Edit
            ...
            $(document).on('click', '.btnEdit', function(e) {
              ...
              let id = $(this).data('id');
              let url = '{{ route('master_data.bidang.edit', ':id') }}';
              ...
              setTimeout(function() {
                  $.ajax({
                      ...
                      success: function(response) {
                          ...
                          $('#labelModal').text('Edit Data Bidang');
                      },
            ...
            $(document).on('click', '.btnDelete', function (e) {
              ...
              Swal.fire({
                  ...
                  if (result.isConfirmed) {
                      let url = '{{ route('master_data.bidang.delete', ':id') }}';
                      url = url.replace(':id', id);
