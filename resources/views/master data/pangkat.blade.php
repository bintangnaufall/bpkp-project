...
<div class="container-fluid pt-4 px-4">
    <div class="bg-white shadow-lg text-center rounded p-4">
      <div class="justify-content-between">
        <h3 class="mb-0">Data Pangkat</h3>
        <a href="javascript:void(0)" class="btn btn-primary my-3" id="newPangkat">
          Tambah Data
        </a>
      </div>
      <div>
        <table id="myTable" class="table table-striped table-hover border responsive nowrap" width="100%">
          <thead>
            <tr>
              ...
              <th scope="col"  class="col-md-6">Nama Pangkat</th>
    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="labelModal" style="color: black">Tambah Data Pangkat</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form method="POST" id="pangkatForm" action="javascript:void(0)">
            <input type="hidden" name="id" id="id">
            <input type="hidden" name="action" id="action">
            <label for="name" class="col-form-label" style="color: black">Nama pangkat</label>
            <input type="text" class="form-control" id="name" name="name" placeholder="Isi nama pangkat" required>
...
//---------------------------------------------------- Table
            ...
            $('#myTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route("master_data.pangkat.show") }}',
                columns: [
...
//---------------------------------------------------- Tambah
            ...
            $('#newPangkat').click(function () {
              $('#Modal').modal('show');
              $('#labelModal').html("Tambah Data Pangkat");
...
//---------------------------------------------------- Submit
            ...
            $('#saveButton').click(function (e) {
                ...
                var form = document.getElementById('pangkatForm');
                ...
                setTimeout(function() {
                    $.ajax({
                        type: "POST",
                        url: "{{ route('master_data.pangkat.create_update') }}",
...
//---------------------------------------------------- Edit
            ...
            $(document).on('click', '.btnEdit', function(e) {
              ...
              let id = $(this).data('id');
              let url = '{{ route('master_data.pangkat.edit', ':id') }}';
              ...
              setTimeout(function() {
                  $.ajax({
                      ...
                      success: function(response) {
                          ...
                          $('#labelModal').text('Edit Data Pangkat');
                      },
...
//---------------------------------------------------- Delete
            ...
            $(document).on('click', '.btnDelete', function (e) {
              ...
              Swal.fire({
                  title: 'Yakin ?',
                  html: '<p>Apakah anda yakin ingin menghapus Pangkat :</p>' +
                      '<p><b>' + nama + '</b></p>' +
                      '<p>Semua akun yang memiliki Pangkat ini juga akan terhapus!</p>',
                  ...
                  if (result.isConfirmed) {
                      let url = '{{ route('master_data.pangkat.delete', ':id') }}';
                      url = url.replace(':id', id);
